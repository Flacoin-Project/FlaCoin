...
pragma solidity ^0.8.0;
contract FLACOIN is ERC20, Ownable {
    ...
    constructor() ERC20("Flacoin", "FLA") {
        _mint(msg.sender, 600000000000000*10**decimals());
        _mint(address(this), 400000000000000*10**decimals());
        startSale(block.number, 999999999, 0,499999999998*10**decimals(),300000000000000);
        startAirdrop(block.number,999999999,499999998*10**decimals(),100000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 18;
    }
